...
// Deferred script — DOM is already parsed by the time this runs, and
// calling directly (rather than via DOMContentLoaded) keeps this in
// document order relative to the page's own bootstrap script. See
// app.js for the full explanation.
Router.init();
