  ...
  function renderHistory() {
    ...
    wrap.innerHTML = logs.length ? logs.map(l => `
      <div class="log-item">
        ...
        <button class="icon-btn" data-edit-growth="${l.id}" aria-label="Edit entry">${Icons.edit}</button>
    ...
    wrap.querySelectorAll('[data-edit-growth]').forEach(btn =>
      btn.addEventListener('click', () => LogEditor.open(btn.dataset.editGrowth, render)));
  }
