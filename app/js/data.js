...
const Data = (() => {
  ...
  const TOOLS = [
    ...
    { id: 'activity-generator', name: 'Activity Generator', desc: 'Age-appropriate play ideas', icon: 'activity', category: 'Play', premium: true, route: 'tools.html#activity-generator' },
    ...
    { id: 'shopping-list', name: 'Shopping List', desc: 'Never forget the diapers again', icon: 'checklist', category: 'Planning', premium: false, route: 'tools.html#shopping-list' },
    ...
    { id: 'temp-tracker', name: 'Temperature Tracker', desc: 'Log fevers and spot patterns', icon: 'thermometer', category: 'Health', premium: false, route: 'tracker.html?tab=temperature' },
    ...
    { id: 'sleep-sounds', name: 'Sleep Sounds', desc: 'Calming ambient sounds for naptime', icon: 'playlist', category: 'Sleep', premium: true, route: 'tools.html#sleep-sounds' },
    { id: 'white-noise', name: 'White Noise Player', desc: 'Steady, soothing background sound', icon: 'playlist', category: 'Sleep', premium: true, route: 'tools.html#white-noise' },
    { id: 'lullaby-player', name: 'Lullaby Player', desc: 'Gentle melodies for bedtime', icon: 'playlist', category: 'Sleep', premium: true, route: 'tools.html#lullaby-player' },
    ...
    { id: 'mood-journal', name: 'Mood Journal', desc: 'A private place to check in', icon: 'journal', category: 'Self Care', premium: false, route: 'tools.html#mood-journal' },
    ...
    { id: 'hospital-bag', name: 'Hospital Bag Checklist', desc: 'Everything packed before due date', icon: 'bag', category: 'Planning', premium: false, route: 'tools.html#hospital-bag' },
    { id: 'school-checklist', name: 'School Checklist', desc: 'Back-to-school, sorted', icon: 'checklist', category: 'Planning', premium: false, route: 'tools.html#school-checklist' },
    { id: 'packing-checklist', name: 'Packing Checklist', desc: 'Travel with a baby, minus the chaos', icon: 'bag', category: 'Planning', premium: false, route: 'tools.html#packing-checklist' },
    { id: 'family-budget', name: 'Family Budget', desc: 'See where it all goes', icon: 'wallet', category: 'Finance', premium: true, route: 'tools.html#family-budget' },
    ...
    { id: 'savings-goal', name: 'Savings Goal', desc: 'College fund, stroller, or rainy day', icon: 'piggy', category: 'Finance', premium: true, route: 'tools.html#savings-goal' },
    ...
    { id: 'export-data', name: 'Export PDF / CSV', desc: 'Share reports with your pediatrician', icon: 'download', category: 'Data', premium: true, route: 'profile.html#export' },
    { id: 'backup-restore', name: 'Backup & Restore', desc: 'Keep your data safe across devices', icon: 'upload', category: 'Data', premium: false, route: 'profile.html#backup' },
  ];

  const TOOL_CATEGORIES = ['All', 'Feeding', 'Sleep', 'Health', 'Growth', 'Planning', 'Play', 'Self Care', 'Finance', 'Data'];
