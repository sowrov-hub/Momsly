...
const Data = (() => {
  ...
  // `repeat` decides which fields the reminder sheet shows: 'once' asks for
  // a calendar date (an appointment happens on a day), 'daily' just a time
  // of day, and anything with `every` repeats on that interval.
  const REMINDER_PRESETS = [
    ...
    { title: 'Doctor visit', category: 'health', icon: 'calendar', every: null, repeat: 'once' },
    { title: 'Vaccination', category: 'health', icon: 'syringe', every: null, repeat: 'once' },
