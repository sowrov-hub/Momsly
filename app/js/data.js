...
const Data = (() => {
  ...
  const TOOLS = [
    ...
    { id: 'growth-tracker', name: 'Growth Tracker', desc: 'Weight and height together, with charts over time', icon: 'growth', category: 'Health', premium: false, route: 'growth.html' },
    ...
    { id: 'feed-tracker', name: 'Feed Tracker', desc: 'Bottle, breastfeed & pump, all in one', icon: 'bottle', category: 'Feeding', premium: false, route: 'tracker.html?tab=feeding' },
    ...
    { id: 'photo-memories', name: 'Memory Book', desc: 'A printable, page-by-page album of the little moments', icon: 'camera', category: 'Growth', premium: false, route: 'tools.html#photo-memories' },
    { id: 'medicine-health', name: 'Medicine & Health', desc: 'Medications, vaccines & health logs in one place', icon: 'medicine', category: 'Health', premium: false, route: 'medicine-health.html' },
    { id: 'doctor-reminder', name: 'Doctor Appointments', desc: 'Well visits & check-ups, saved to a date', icon: 'calendar', category: 'Health', premium: false, route: 'tools.html#doctor-appointment' },
  ];
  ...
  // Reminders are recurring time-of-day nudges — `repeat` picks between a
  // one-off, a daily time, or an interval. Anything tied to a calendar
  // date (a check-up) belongs in Doctor Appointments, not here.
  const REMINDER_PRESETS = [
    { title: 'Feed baby', category: 'feeding', icon: 'bottle', every: 180, repeat: 'interval' },
    { title: 'Medicine', category: 'medicine', icon: 'medicine', every: null, repeat: 'daily' },
    { title: 'Nap time', category: 'sleep', icon: 'sleep', every: null, repeat: 'daily' },
    { title: 'Bedtime', category: 'sleep', icon: 'moon', every: null, repeat: 'daily' },
    { title: 'Water break', category: 'water', icon: 'droplet', every: 120, repeat: 'interval' },
    { title: 'School drop-off', category: 'school', icon: 'checklist', every: null, repeat: 'daily' },
    { title: 'Bath time', category: 'care', icon: 'droplet', every: null, repeat: 'daily' },
    { title: 'Homework', category: 'school', icon: 'checklist', every: null, repeat: 'daily' },
  ];
