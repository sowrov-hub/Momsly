...
const Data = (() => {
  ...
  const TOOLS = [
    ...
    { id: 'ask-momsly', name: 'Ask Momsly', desc: 'AI answers to your parenting questions, any hour', icon: 'sparkles', category: 'Planning', premium: false, route: 'ask.html' },
    ...
    { id: 'vaccine-tracker', name: 'Vaccination Schedule', desc: 'Every shot, with due dates and what comes next', icon: 'syringe', category: 'Health', premium: true, route: 'medicine-health.html' },
