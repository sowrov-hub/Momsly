...
const UI = (() => {
  ...
  function openSheet(id) {
    ...
    // Lets a sheet's own code react to being opened — used to clear forms
    // so a reopened sheet never shows what was abandoned last time.
    overlay.dispatchEvent(new CustomEvent('sheet:open', { bubbles: true }));
  }
